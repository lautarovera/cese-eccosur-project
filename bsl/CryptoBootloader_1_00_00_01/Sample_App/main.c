...
/*******************************************************************************
 * Sample Application example for MSP430FR5969/6989 using Crypto-Bootloader
 *
 * Description: This application simply toggles a LED in P1.0 and jumps to
 * Crypto-Bootloader when P1.1 is low
 *
 *
 *              MS430FR5969/6989
 *             ------------------
 *         /|\|                  |
 *          | |                  |
 *          --|RST           P1.1|<-- Jump to bootloader when low (internal pull-up)
 *            |                  |
 *            |              P1.0|--> toggle pin
 *            |                  |
 *            |                  |
